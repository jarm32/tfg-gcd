...
primer_csv = "../data/Embeddings_keywords_sinlocl.csv"
segundo_archivo = "../data/Matriz_Investigadores_Keywords.xlsx"
salida_csv = "../data/Matriz_Investigadores_Keywords_sinlocl.xlsx"
