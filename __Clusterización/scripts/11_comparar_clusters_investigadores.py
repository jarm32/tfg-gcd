...
# Leer tus archivos
# ---------------------------------------------
path_jerMan = "../results/Clusters_resultado_JerCos8.xlsx"
path_umap = "../results/Clusters_resultado_JerCosUMAP.xlsx"
...
plt.tight_layout()
plt.savefig(
    "../results/solapamiento_investigadores_jerCos_vs_jerCosUMAP.png",
    dpi=300,
    bbox_inches="tight"
)
plt.show()
