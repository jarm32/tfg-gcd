...
df = pd.read_excel("C:/Code/tfg-gcd/_Clusterization/Investigadores y keywords/Matriz_Investigadores_Keywords.xlsx", index_col=0).fillna(0)
...
emb_df.to_csv("Embeddings_keywords.csv")
