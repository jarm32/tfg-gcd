...
setwd("C:/Users/josep/Downloads/Zona de trabajo/inv vs inv de revistas")
...
# Añadir tipo de empleado y usarlo como categoría
...
################################################################################
ui <- fluidPage(
  titlePanel("Grafo investigadores IUMPA (revistas)"),
  fluidRow(
    column(
      width = 4,
