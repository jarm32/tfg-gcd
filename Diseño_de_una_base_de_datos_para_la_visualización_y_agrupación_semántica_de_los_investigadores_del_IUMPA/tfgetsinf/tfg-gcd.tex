...
% Podría valorarse añadir un gantt aquí
...
\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth]{imgs/eda_tipo_empleado.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{imgs/eda_articulos_vs_revistas.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{imgs/eda_investigadores_por_proyecto_agrupado.png}
...
Estos valores muestran que la base de datos final contiene un volumen suficiente de entidades y relaciones para sostener las fases posteriores del trabajo, incorporando además una capa temática derivada de las palabras clave asociadas a las revistas. No obstante, las distribuciones observadas reflejan que la información recopilada no es completamente uniforme entre todos los investigadores, por lo que esta heterogeneidad debe tenerse en cuenta al interpretar los grafos y los resultados de agrupación semántica.
...
\newblock Consultado el 13 de mayo de 2026.
