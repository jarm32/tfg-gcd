...
Como ampliación analítica, se abordó el estudio de afinidades temáticas entre investigadores a partir de las revistas en las que han publicado. Para ello se extrajeron palabras clave representativas, se construyeron matrices de datos específicas y se evaluaron distintas estrategias de agrupación. Tras comprobar las limitaciones de los enfoques basados en coincidencias literales de palabras, se adoptó una representación semántica mediante \textit{word embeddings}, sobre la que se aplicaron técnicas de \textit{clustering} jerárquico y reducción de dimensionalidad, con el objetivo de identificar perfiles investigadores similares que puedan facilitar la colaboración y el trabajo en equipo entre investigadores con núcleos temáticos afines. Los resultados obtenidos permiten complementar la visión relacional de los grafos con una aproximación temática a la actividad investigadora del IUMPA.
...
Al Instituto Universitario de Matemática Pura y Aplicada, por permitirme desarrollar este trabajo a partir de su actividad investigadora y por ofrecerme un entorno en el que he podido aplicar y ampliar los conocimientos adquiridos durante el grado. 

Especialmente a José Manuel Calabuig y a Andrés Roger Arnau, por tutorizarme, orientarme y acompañarme durante el desarrollo del proyecto. Gracias por su disponibilidad, por sus indicaciones en cada fase del trabajo y por ayudarme a enfocar las decisiones más importantes de la memoria y del proyecto.

A mis padres, por confiar siempre en mí, por quererme como lo hacen y por haberme dado la oportunidad de llegar hasta aquí. Gracias por acompañarme durante toda la carrera, por enseñarme el valor del esfuerzo y la constancia, y por estar presentes tanto en los momentos buenos como en aquellos en los que el camino se hizo más difícil.

A mi hermano, por estar siempre presente, por ser capaz de sacarme una sonrisa incluso en los momentos más complicados y por apoyarme, a su manera, durante todos estos años.

A mi prima, por su cariño, su confianza constante en mí y por estar siempre ahí, haciendo que todo sea un poco más fácil.

A mi pareja, por su paciencia, comprensión y apoyo incondicional durante este proceso. Gracias por acompañarme en cada decisión importante, por animarme cuando lo necesitaba, por escucharme en los momentos de duda y por estar a mi lado durante esta etapa.

Finalmente, a todas las personas que, de una forma u otra, me han acompañado a lo largo de la carrera y han contribuido a que este trabajo haya podido realizarse.
...
En esta memoria se utiliza el término base de datos en un sentido funcional, para referirse al conjunto estructurado y relacional de ficheros tabulares generado durante el proyecto. Por tanto, no debe entenderse necesariamente como una base de datos implementada en un sistema gestor tradicional, sino como una estructura organizada de datos preparada para su consulta, visualización y análisis posterior.
...
Más adelante, se expone la ampliación analítica del trabajo, centrada en el estudio de afinidades temáticas entre investigadores mediante la extracción de palabras clave, la construcción de representaciones temáticas y la aplicación de distintos métodos de \textit{clustering} y reducción de dimensionalidad. Además, se sintetizan los resultados obtenidos, se valoran las limitaciones del sistema desarrollado y se recogen las conclusiones principales, junto con posibles líneas de trabajo futuro.
...
El análisis de la actividad investigadora requiere organizar información procedente de fuentes diversas y, con frecuencia, heterogéneas. Esta información suele encontrarse dispersa en plataformas bibliográficas, directorios institucionales y otras fuentes externas, lo que dificulta su consulta conjunta y limita la obtención de una visión global de la estructura científica de una institución. Desde esta perspectiva, los enfoques vinculados a la bibliometría y al análisis de la actividad científica proporcionan un marco útil para estudiar publicaciones, revistas, autores, proyectos y relaciones de colaboración. Por ello, resulta necesario definir modelos que permitan integrar, relacionar y explotar esta información de forma coherente.

Una vez estructurados los datos, su utilidad depende en gran medida de la forma en que puedan ser consultados e interpretados. Las tablas permiten almacenar la información de manera ordenada, pero no siempre facilitan la comprensión de las relaciones existentes entre los distintos elementos del sistema. En este sentido, los modelos basados en entidades y relaciones, así como su representación mediante grafos, constituyen una herramienta especialmente adecuada para representar vínculos como la colaboración, la publicación o la participación en proyectos, mientras que las aplicaciones interactivas permiten explorar dichas relaciones de forma más flexible y comprensible.

Además de representar relaciones explícitas, como participaciones comunes, también puede resultar útil analizar similitudes menos directas entre perfiles investigadores. Dos
investigadores pueden estar próximos no solo porque hayan trabajado juntos, sino también porque desarrollen su actividad en ámbitos temáticos relacionados. Por este motivo, las técnicas de representación vectorial, los \textit{embeddings}, los métodos de \textit{clustering} y las técnicas de reducción de dimensionalidad ofrecen una perspectiva complementaria, orientada a identificar afinidades temáticas a partir de la información disponible sobre la producción científica.

\section{Información investigadora, bibliometría y análisis de la actividad científica}

El análisis de la actividad científica de una institución requiere transformar información dispersa en una representación organizada y comprensible. La actividad investigadora no se refleja únicamente en los resultados finales, sino también en el contexto en el que estos se generan y en las relaciones que se establecen alrededor de ellos. Por este motivo, el estudio de la producción científica suele apoyarse en información bibliográfica, institucional y documental que permite describir autores, publicaciones, revistas, proyectos, citas y vínculos de colaboración.

Desde esta perspectiva, la bibliometría y la cienciometría proporcionan un marco de referencia para analizar la actividad científica a partir de datos bibliográficos. Estos enfoques permiten estudiar la producción investigadora mediante publicaciones, revistas, autores, instituciones, citas y patrones de colaboración \cite{price,moed}. Desde los primeros trabajos sobre redes de documentos científicos, la literatura ha mostrado que la ciencia puede analizarse no solo como un conjunto de publicaciones aisladas, sino también como una red de relaciones entre documentos, autores y fuentes de información \cite{price}.

En este tipo de análisis, las publicaciones científicas constituyen una fuente de información especialmente relevante, ya que permiten describir parte de la producción de los investigadores y establecer relaciones entre ellos. La coautoría, por ejemplo, permite representar vínculos derivados de publicaciones compartidas, mientras que otras relaciones bibliométricas clásicas, como el acoplamiento bibliográfico o la co-citación, se han utilizado tradicionalmente para estudiar proximidades entre documentos, autores o áreas de investigación \cite{kessler,small}. Aunque el presente trabajo no realiza un análisis de citas en sentido estricto, sí se apoya en la idea de que la información académica puede transformarse en una estructura relacional capaz de describir conexiones entre investigadores, revistas y proyectos.

La bibliometría moderna no se limita a contar publicaciones o citas, sino que también permite estudiar la estructura intelectual, social y temática de un campo científico. En este sentido, los métodos bibliométricos se han utilizado para identificar comunidades de investigación, patrones de colaboración, tendencias temáticas y relaciones entre fuentes científicas \cite{zupic}. Esta perspectiva resulta especialmente útil en contextos institucionales, donde interesa obtener una visión conjunta de la actividad de un grupo de investigación, más que evaluar únicamente registros aislados.

Sin embargo, este tipo de información suele presentar dificultades importantes desde el punto de vista del tratamiento de datos. Es habitual que proceda de fuentes distintas, con formatos heterogéneos, criterios de identificación no siempre uniformes y distintos niveles de completitud. Además, pueden aparecer duplicidades, variantes en los nombres de autores, cambios de firma, ausencia de perfiles completos o diferencias de cobertura entre plataformas. Estos problemas son habituales en estudios bibliométricos y obligan a incorporar fases de depuración, normalización y validación antes de realizar cualquier análisis posterior \cite{moed,zupic}.
...
Desde esta perspectiva, la base de datos construida en este trabajo puede entenderse como una infraestructura de información científica a escala institucional. Su finalidad no es establecer clasificaciones ni métricas de productividad individual, sino organizar información dispersa y convertirla en un recurso útil para la consulta, la visualización y el análisis exploratorio. Esta distinción resulta relevante, ya que evita interpretar los datos recopilados como una medida exhaustiva de la actividad investigadora y sitúa el trabajo dentro de un enfoque descriptivo, relacional y exploratorio.

\section{Representación de bases de datos, grafos y visualización interactiva}

Una vez recopilada y organizada la información investigadora, el siguiente problema consiste en representarla de forma que pueda ser consultada e interpretada. En este trabajo, los elementos principales del sistema pueden entenderse como entidades conectadas mediante relaciones. Esta estructura encaja de forma natural con una visión basada en grafos, en la que los nodos se corresponden con las entidades y las aristas con los vínculos entre ellas \cite{newmannetworks}.

Los modelos de datos orientados a grafos resultan especialmente adecuados cuando el interés principal no reside únicamente en los atributos individuales de cada elemento, sino en las conexiones que se establecen entre ellos. En una base de datos de grafos, las relaciones tienen un papel central y pueden consultarse directamente como parte de la estructura del sistema. Este tipo de aproximación se ha utilizado en problemas donde existen datos altamente conectados, como redes sociales, sistemas de recomendación, bases de conocimiento o análisis de relaciones científicas \cite{angles,robinson}.

En el contexto del presente proyecto, esta naturaleza relacional se observa en el hecho de que un investigador puede publicar en varias revistas, participar en varios proyectos, compartir artículos con otros investigadores o pertenecer a distintas áreas. Sin embargo, esto no implica necesariamente que la implementación deba realizarse en un sistema gestor de bases de datos de grafos. También es posible conservar la información en ficheros tabulares estructurados, siempre que las entidades y relaciones queden suficientemente documentadas y puedan transformarse posteriormente en nodos y enlaces para su visualización. Esta decisión resulta razonable cuando el objetivo principal es construir una herramienta exploratoria, mantener control sobre la depuración de los datos y facilitar la revisión de los ficheros generados.

La visualización mediante grafos permite pasar de una visión tabular a una visión relacional de la información. En lugar de consultar registros de forma aislada, el usuario puede observar conexiones, patrones de colaboración, nodos especialmente conectados o subconjuntos de la red. Este tipo de representación se ha empleado con frecuencia en análisis bibliométricos y mapas de ciencia, donde se visualizan relaciones entre autores, revistas, documentos o palabras clave \cite{eck,cobo}.

Además, cuando la red contiene muchos nodos y enlaces, la interactividad se vuelve fundamental. La visualización exploratoria de datos suele apoyarse en el principio de ofrecer primero una visión general, permitir después el filtrado y finalmente mostrar detalles bajo demanda \cite{shneiderman}. Este enfoque resulta directamente aplicable a la aplicación desarrollada en el trabajo, ya que los selectores, filtros, leyendas interactivas, información emergente y paneles informativos permiten pasar de una vista global de la red a la consulta de elementos concretos.

Herramientas como Shiny permiten construir aplicaciones web orientadas a la exploración de datos, mientras que librerías de visualización como ECharts facilitan la creación de grafos dinámicos e interactivos \cite{shiny,echarts}. Su uso permite transformar una representación estática de la información en un entorno de consulta más accesible, en el que el usuario puede navegar por las relaciones y adaptar la visualización a distintas preguntas de análisis.

Por tanto, la visualización interactiva no debe entenderse como un componente meramente estético, sino como una forma de análisis. La aplicación permite consultar relaciones que serían menos evidentes en tablas estáticas y facilita una lectura progresiva de la actividad investigadora del instituto. Aun así, conviene recordar que la posición de los nodos en un grafo interactivo depende del algoritmo de disposición visual utilizado y no debe interpretarse automáticamente como una medida matemática de proximidad temática o científica.

\section{Representación temática, \textit{embeddings} y agrupación de perfiles investigadores}

Las relaciones explícitas, como las colaboraciones entre autores o la participación conjunta en proyectos, permiten describir una parte importante de la actividad investigadora, pero no siempre reflejan todas las proximidades existentes entre perfiles. También pueden existir afinidades temáticas entre investigadores que trabajan en ámbitos relacionados, aunque no hayan colaborado directamente. Por ello, resulta útil complementar el análisis relacional con técnicas de representación temática y agrupación de perfiles investigadores.

Esta perspectiva requiere transformar información textual en una representación comparable entre perfiles. En recuperación de información, una forma habitual de representar textos consiste en describir documentos a partir de los términos que contienen, dando lugar a representaciones documento-término o entidad-término \cite{manning}. Este tipo de representación permite calcular similitudes entre estos documentos o perfiles, aunque su utilidad depende en gran medida del vocabulario utilizado y de la forma en que se ponderen los términos.

En este contexto, las técnicas de ponderación de términos permiten reducir la influencia de palabras demasiado frecuentes y destacar aquellas con mayor capacidad discriminativa. Métodos clásicos como TF-IDF se han utilizado ampliamente para asignar pesos a los términos en función de su frecuencia en un documento y de su distribución dentro del conjunto analizado \cite{salton,manning}. Aunque este tipo de representación resulta interpretable y sencilla de construir, la similitud entre perfiles depende principalmente de coincidencias explícitas entre palabras.

Esta limitación es especialmente relevante cuando se trabaja con información temática procedente de revistas, áreas científicas o palabras clave heterogéneas. Dos perfiles pueden ser próximos desde un punto de vista conceptual y, sin embargo, aparecer alejados si utilizan términos diferentes para describir contenidos relacionados. Por este motivo, las representaciones semánticas mediante \textit{embeddings} ofrecen una alternativa más flexible que los enfoques basados únicamente en coincidencias literales.

Los \textit{word embeddings} representan palabras o expresiones como vectores en un espacio continuo, de forma que términos relacionados tienden a aparecer próximos en dicho espacio. Los primeros modelos de este tipo mostraron que era posible aprender representaciones distribuidas capaces de capturar regularidades semánticas y sintácticas a partir de grandes corpus textuales \cite{mikolov}. Posteriormente, los modelos basados en arquitecturas Transformer y enfoques como Sentence-BERT permitieron obtener representaciones semánticas de frases, términos o textos más largos, comparables mediante medidas como la similitud coseno \cite{sentencebert}.

En el caso de perfiles investigadores, este enfoque permite representar a cada persona de forma más flexible a partir de los términos asociados a su producción científica. En lugar de comparar únicamente si dos investigadores comparten exactamente las mismas palabras clave, es posible comparar la proximidad semántica entre los términos que caracterizan sus revistas. De este modo, las representaciones vectoriales permiten incorporar relaciones conceptuales entre palabras y reducir la dependencia de coincidencias textuales exactas.

Una vez construida una representación numérica de cada investigador, el problema puede abordarse mediante técnicas de \textit{clustering} no supervisado. El \textit{clustering} busca organizar observaciones en grupos de forma que los elementos de un mismo grupo sean más similares entre sí que respecto a elementos de otros grupos \cite{hastie}. En este contexto, los métodos de \textit{clustering} resultan útiles para explorar si existen patrones latentes en los perfiles temáticos de los investigadores, sin imponer previamente una clasificación cerrada.

No obstante, en un análisis exploratorio como el planteado en este trabajo, el \textit{clustering} no debe interpretarse como una clasificación definitiva. Los resultados dependen de la representación de entrada, de la medida de distancia utilizada, del número de grupos, del algoritmo elegido y de las fases previas de depuración. Por ello, resulta conveniente comparar varias configuraciones y valorar no solo las métricas internas, sino también la coherencia temática de los grupos obtenidos.

Entre las métricas internas más utilizadas se encuentra el índice de Silhouette, que compara la cohesión de cada observación con su propio grupo frente a su separación respecto a otros grupos \cite{rousseeuw}. Valores altos sugieren una mejor separación entre grupos, pero no garantizan por sí solos que los grupos tengan una interpretación científica clara. Por este motivo, en estudios de perfiles investigadores conviene combinar métricas cuantitativas con una revisión cualitativa y contextual de los resultados.

También es habitual emplear técnicas de reducción de dimensionalidad para visualizar o resumir representaciones de alta dimensión. PCA proporciona una reducción lineal basada en la varianza \cite{jolliffe}, mientras que UMAP permite obtener proyecciones no lineales orientadas a preservar relaciones de vecindad en los datos \cite{umap}. Estas técnicas pueden facilitar la visualización de perfiles, pero deben interpretarse con cautela, ya que una proyección en baja dimensión puede modificar la percepción de proximidad entre observaciones.

En general, la agrupación temática de investigadores debe entenderse como una fase exploratoria que complementa la visualización relacional. Mientras que los grafos muestran relaciones explícitas, las representaciones semánticas y el \textit{clustering} permiten estudiar proximidades temáticas menos evidentes. El valor del análisis no reside en producir una clasificación cerrada de los investigadores, sino en ofrecer una herramienta adicional para explorar posibles afinidades y generar hipótesis interpretables sobre la estructura investigadora de una institución.

\section{Síntesis del estado del arte y conexión con el trabajo}

Los apartados anteriores permiten situar el trabajo en la intersección entre el análisis bibliométrico de información científica, la representación relacional mediante grafos y la agrupación temática de perfiles investigadores. Esta combinación justifica el enfoque de construir primero una base de datos estructurada, utilizarla después para generar visualizaciones interactivas de relaciones explícitas y, finalmente, complementarla con un análisis semántico exploratorio orientado a detectar afinidades temáticas menos evidentes.

La aportación del trabajo no consiste en proponer un nuevo algoritmo bibliométrico o de \textit{clustering}, sino en integrar técnicas existentes en un caso aplicado a escala institucional. Por ello, los resultados deben interpretarse como una herramienta de consulta, visualización y exploración de la actividad investigadora del IUMPA, no como una clasificación cerrada ni como una evaluación individual de sus investigadores.
...
Desde el punto de vista ético, los grafos y los modelos de \textit{clustering} desarrollados deben interpretarse con cautela. Las relaciones de colaboración representadas muestran conexiones derivadas de publicaciones o proyectos, pero no reflejan necesariamente la totalidad de la actividad científica ni la intensidad real de todas las relaciones profesionales. Del mismo modo, las agrupaciones semánticas obtenidas mediante técnicas de \textit{clustering} no deben entenderse como categorías cerradas, sino como una aproximación exploratoria basada en las revistas, palabras clave y datos disponibles.
...
Por último, para la fase posterior de agrupación semántica se recurrió a fuentes auxiliares centradas en la caracterización de revistas, como DOAJ y SCImago \cite{doaj,scimago}. Estas fuentes se emplearon para obtener términos representativos asociados a las revistas en las que habían publicado los investigadores. Su función no fue definir las relaciones principales de la base de datos, sino proporcionar información temática que sería utilizada posteriormente en el análisis semántico.
...
Respecto a los investigadores internos, la Figura~\ref{fig:eda_tipo_empleado} muestra la distribución por tipo de empleado. La mayor parte de los registros corresponden a investigadores, mientras que el personal en formación y el personal investigador en formación representan una proporción menor dentro del conjunto. Esta información resulta relevante porque esta misma clasificación se utilizó posteriormente en la aplicación interactiva para diferenciar visualmente los nodos de los grafos.
...
La Figura~\ref{fig:app_vista_general} muestra una vista general de la aplicación desarrollada, en la que se observa la disposición de los controles de selección, el área principal de visualización del grafo y el panel destinado a mostrar información asociada a los elementos seleccionados.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{imgs/app_vista_general.png}
    \caption{Vista general de la aplicación interactiva desarrollada.}
    \label{fig:app_vista_general}
\end{figure}
...
La Figura~\ref{fig:info_nodos_grafos} muestra una vista general del panel informativo junto al grafo y varios ejemplos de los bloques de información mostrados al seleccionar distintos tipos de nodo.

\begin{figure}[H]
    \centering

    \includegraphics[width=\textwidth]{imgs/panel_investigador_revistas.png}
    \caption*{(a) Vista general al seleccionar un investigador en el grafo de revistas.}

    \vspace{0.25cm}

    \begin{subfigure}{0.4\textwidth}
        \centering
        \includegraphics[width=\linewidth]{imgs/panel_revista.png}
        \caption*{(b) Revista}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.4\textwidth}
        \centering
        \includegraphics[width=\linewidth]{imgs/panel_proyecto.png}
        \caption*{(c) Proyecto}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.4\textwidth}
        \centering
        \includegraphics[width=\linewidth]{imgs/panel_investigador_proyectos.png}
        \caption*{(d) Investigador en proyectos}
    \end{subfigure}

    \caption{Ejemplos del panel informativo asociado a distintos tipos de nodo en los grafos de producción académica.}
    \label{fig:info_nodos_grafos}
\end{figure}
...
Una vez recopiladas las palabras clave, fue necesario revisar el conjunto global de términos antes de utilizarlo en los modelos de \textit{clustering}. Algunas palabras aparecían asociadas a un gran número de revistas y, por tanto, aportaban poca capacidad diferenciadora. Otras, en cambio, eran demasiado específicas, lo que dificultaba la identificación de patrones compartidos entre investigadores. Por ello, la selección final buscó un equilibrio entre representatividad y utilidad para comparar perfiles temáticos.
...
Con esta estructura, la información textual quedaba transformada en un formato numérico sencillo, adecuado para calcular distancias entre perfiles y aplicar métodos de \textit{clustering}. Su interpretación también resultaba directa, ya que cada investigador quedaba descrito por el conjunto de términos asociados a las revistas en las que había publicado.
...
\vspace{0.2cm}
Entrada para los modelos de \textit{clustering}
\end{minipage}
}
...
La matriz binaria ofrecía una primera representación sencilla e interpretable de los perfiles temáticos. A partir de ella se realizaron distintas pruebas de \textit{clustering}, aplicando diferentes formas de comparar los perfiles de los investigadores. Sin embargo, los resultados obtenidos no mostraron una separación suficientemente clara entre grupos. Las métricas de evaluación, con valores bajos del índice de Silhouette en las mejores pruebas iniciales, indicaban que las agrupaciones generadas no eran lo bastante consistentes. Por ello, se decidió no forzar una interpretación de estos primeros resultados y revisar la forma en que estaban representados los perfiles temáticos.
...
\hline
Representación de entrada & Matriz binaria, matriz ponderada y \textit{embeddings} semánticos & Definir cómo se describe temáticamente cada investigador \\
\hline
...
\hline
Métodos de \textit{clustering} & Jerárquico, K-means, PAM, Fuzzy C-Means, Spectral Clustering, GMM, DBSCAN y HDBSCAN & Comparar distintas formas de construir grupos a partir de los perfiles \\
\hline
Número de grupos o parámetros del \textit{clustering} & Distintos valores de \(k\) en k-means, cortes del dendrograma en jerárquico y variación de parámetros como \(\varepsilon\) en DBSCAN & Estudiar cómo cambia la estructura de grupos según la configuración del modelo \\
\hline
Reducción de dimensionalidad & Configuraciones sin reducción, PCA y UMAP & Comparar las agrupaciones obtenidas en el espacio original y en proyecciones de menor dimensión \\
\hline
...
\hline
\end{tabular}
\caption{Elementos considerados en el proceso de \textit{clustering} temático.}
\label{tab:elementos_clustering}
\end{table}

\subsection{Primeras pruebas con palabras clave explícitas}

La primera aproximación al \textit{clustering} se realizó utilizando directamente la matriz de presencia y ausencia de palabras clave. En esta representación, cada investigador quedaba descrito por los términos asociados a las revistas en las que había publicado, sin incorporar todavía ponderaciones ni relaciones semánticas entre palabras. El objetivo de esta fase era comprobar si las coincidencias literales entre palabras clave bastaban para identificar grupos de investigadores con perfiles temáticos próximos.
...
En cuanto a los métodos de \textit{clustering}, la variante jerárquica fue una de las primeras alternativas utilizadas en esta fase, ya que permitía analizar diferentes particionesa partir de un mismo dendrograma. Para ello, se ensayaron distintos criterios de enlace, como \textit{average}, \textit{complete}, \textit{single} y \textit{ward.D2}, y se compararon varios valores de \(k\). Esta variedad de configuraciones permitía comprobar si los grupos aparecían de forma estable o si dependían en exceso de la métrica y del enlace utilizados.

Junto a las pruebas jerárquicas, también se aplicaron otros métodos de \textit{clustering} sobre la misma representación, como K-means, PAM, Fuzzy C-Means, Spectral Clustering o GMM. La finalidad de estas pruebas era comprobar si las limitaciones observadas procedían del algoritmo de \textit{clustering} o de la propia representación basada en coincidencias literales de palabras clave. La Tabla~\ref{tab:primeras_pruebas_keywords} muestra un resumen de las principales configuraciones probadas en esta fase inicial y de la interpretación general obtenida a partir de ellas.
...
Los resultados obtenidos en esta primera fase mostraron una separación limitada entre grupos. La mejor configuración dentro del \textit{clustering} jerárquico fue la basada en distancia Manhattan, con un valor máximo de Silhouette de 0,329, mientras que el resto de métricas se mantuvieron en valores más bajos. Los métodos alternativos (K-means, PAM, Fuzzy C-Means, Spectral Clustering y GMM) tampoco ofrecieron una mejora clara, produciendo valores reducidos y agrupaciones difíciles de interpretar en general.
...
Además de los valores numéricos, las visualizaciones generadas durante esta fase permitieron observar solapamientos entre perfiles y particiones poco equilibradas. La Figura~\ref{fig:primeras_pruebas_keywords} muestra una configuración representativa de esta primera etapa, basada en distancia Manhattan y \textit{clustering} jerárquico con enlace \textit{average}. Su objetivo no es presentar un modelo final, sino ilustrar las limitaciones observadas al trabajar únicamente con coincidencias explícitas de palabras clave. Aunque esta configuración fue la que obtuvo el mejor valor de Silhouette dentro de las pruebas iniciales, la proyección MDS muestra una separación todavía difusa entre perfiles y el gráfico de Silhouette refleja diferencias claras en la cohesión de los grupos obtenidos.
...
\hline
K-means + Euclídea & 0,304 & Mejora respecto a K-means inicial, pero con \textit{clusters} poco representativos \\
\hline
...
\subsection{Representaciones semánticas, métodos de \textit{clustering} y reducción de dimensionalidad}

Tras las pruebas con la matriz binaria y con la matriz ponderada, el análisis se trasladó a las representaciones semánticas mediante \textit{word embeddings}. Esta decisión se tomó porque, en las fases anteriores, la comparación entre investigadores seguía dependiendo de la coincidencia explícita entre palabras clave. Con los \textit{embeddings}, cada investigador quedaba descrito mediante un vector continuo que resumía el contenido semántico de sus términos, lo que permitía comparar perfiles no solo por las palabras exactas que compartían, sino también por la proximidad conceptual entre ellas.

Sobre esta nueva representación se abrió una fase más amplia de pruebas. Ya no se trataba únicamente de comparar matrices de palabras clave, sino de estudiar cómo se comportaban los perfiles semánticos bajo distintas medidas de proximidad, métodos de \textit{clustering} y técnicas de reducción de dimensionalidad. En esta etapa se probaron medidas como coseno, correlación, distancia euclídea y Manhattan, con el objetivo de comprobar si la estructura de grupos dependía de una única forma de medir la cercanía entre perfiles o si aparecían patrones similares bajo distintas métricas.

El \textit{clustering} jerárquico fue una de las alternativas principales en esta fase. Se utilizó una estrategia aglomerativa, principalmente con enlace promedio (\textit{average}), que permitía construir progresivamente un dendrograma y estudiar distintos cortes.. Esta característica resultaba adecuada para el carácter exploratorio del análisis, ya que no obligaba a fijar un único número de grupos desde el inicio. En las pruebas realizadas se compararon distintos valores de \(k\), de forma que era posible observar cómo cambiaban las particiones al variar el nivel de corte del árbol.

Las primeras configuraciones jerárquicas sobre \textit{embeddings} ofrecieron valores de Silhouette superiores a los obtenidos en varias pruebas con palabras clave explícitas. Por ejemplo, las pruebas con distancia Manhattan, correlación o coseno alcanzaron valores en torno a 0,4 en algunas configuraciones. Sin embargo, estos resultados también debían interpretarse con cautela, ya que varias particiones seguían mostrando una estructura dominada por un grupo principal de gran tamaño. Por tanto, aunque la representación semántica mejoraba la capacidad de comparación entre términos, la calidad numérica de una configuración no garantizaba por sí sola una agrupación equilibrada ni directamente interpretable.

Además del \textit{clustering} jerárquico, se probaron métodos basados en densidad, concretamente DBSCAN~\cite{dbscan} y HDBSCAN~\cite{hdbscan}. Estos métodos resultaban interesantes porque no parten necesariamente de un número fijo de grupos, sino que intentan identificar regiones densas de puntos y separar observaciones que no encajan claramente en ningún grupo. En el caso de DBSCAN se probaron distintos valores del parámetro \(\varepsilon\), comparando configuraciones con y sin reducción de dimensionalidad previa mediante PCA. No obstante, estas pruebas tendieron a generar un único grupo principal junto con un porcentaje elevado de observaciones tratadas como ruido, por lo que no ofrecieron una partición suficientemente útil para el objetivo interpretativo del análisis.
...
También se valoraron técnicas orientadas a representar la estructura global de los perfiles en un espacio de menor dimensión. Entre ellas se consideró PCA~\cite{jolliffe}, utilizada como reducción lineal para conservar una proporción elevada de la varianza antes de aplicar determinados métodos de \textit{clustering}. Esta opción permitía comprobar si una representación más compacta de los \textit{embeddings} facilitaba la formación de grupos o reducía parte del ruido presente en el espacio original. En algunas pruebas, la combinación de PCA con \textit{clustering} jerárquico incrementó el valor de Silhouette, aunque volvió a aparecer el problema de grupos dominantes, por lo que tampoco podía considerarse una solución suficiente por sí misma.

Dentro de las técnicas de reducción no lineal, UMAP adquirió un papel especialmente relevante~\cite{umap}. A diferencia de PCA, que proyecta los datos mediante combinaciones lineales, UMAP busca preservar relaciones de vecindad entre observaciones en un espacio de menor dimensión, lo que lo hacía adecuado para trabajar con \textit{embeddings} semánticos, ya que permitía comprobar si los perfiles de investigadores presentaban una estructura más clara al proyectarse en dos dimensiones.

En las pruebas iniciales con UMAP, su combinación con \textit{clustering} jerárquico basado en distancia coseno produjo una separación más clara que otras configuraciones. En concreto, se obtuvo un valor medio de Silhouette de 0,602 y se identificaron tres grupos principales, lo que suponía una mejora respecto a las pruebas jerárquicas realizadas directamente sobre los \textit{embeddings}, como Manhattan con \(S=0,413\), Manhattan con PCA con \(S=0,445\), o correlación/coseno con \(S=0,409\). Este resultado indicaba que la reducción no lineal podía facilitar la aparición de estructuras más diferenciadas en el espacio semántico y justificaba revisar con más detalle este tipo de configuración en las fases posteriores del análisis.

La Tabla~\ref{tab:pruebas_embeddings_iniciales} recoge una selección de las configuraciones más representativas probadas sobre los perfiles semánticos iniciales. No se pretende recoger todas las combinaciones exploradas, sino resumir los comportamientos principales observados al aplicar distintas medidas de proximidad, métodos de \textit{clustering} y técnicas de reducción de dimensionalidad sobre los \textit{embeddings}.
...
\hline
Coseno + DBSCAN & 2 \textit{clusters} y 45,2\% de ruido & Incluso con PCA y \(\varepsilon=0,45\), mantiene mucho ruido \\
\hline
Coseno + UMAP + Jerárquico & \(S=0,602\) & Separación inicial más clara, pendiente de revisión posterior \\
\hline
\end{tabular}
\caption{Resumen de pruebas iniciales realizadas sobre representaciones semánticas mediante \textit{embeddings}.}
...
En líneas generales, los resultados muestran que las representaciones semánticas aumentaban el potencial de separación respecto a las matrices basadas en coincidencias literales, aunque la calidad de los grupos seguía dependiendo de la configuración utilizada. Algunas combinaciones alcanzaban valores de Silhouette superiores a los enfoques anteriores, pero todavía generaban particiones poco equilibradas, mientras que los métodos basados en densidad no ofrecían una estructura suficientemente clara. En este contexto, la combinación de UMAP, distancia coseno y \textit{clustering} jerárquico apareció como la alternativa más prometedora dentro de esta fase inicial.

La Figura~\ref{fig:umap_embeddings_inicial} muestra la proyección UMAP obtenida en esta fase inicial con \textit{embeddings}. Esta visualización permite observar por qué esta configuración resultó prometedora, ya que los perfiles aparecen organizados en tres grupos principales con una separación más clara que en las representaciones anteriores.
...
\caption*{(b) Gráfico de Silhouette}
\end{minipage}
\caption{Configuración inicial basada en \textit{embeddings}, UMAP y \textit{clustering} jerárquico con distancia coseno.}
\label{fig:umap_embeddings_inicial}
\end{figure}

La proyección muestra una separación visual más clara que las obtenidas con las matrices de palabras clave, mientras que el gráfico de Silhouette confirma un valor medio elevado, aunque con diferencias entre grupos. En particular, uno de los \textit{clusters} aparece mucho más cohesionado que los demás, lo que indicaba que la configuración era prometedora, pero todavía requería una revisión más detallada antes de considerarse una solución definitiva.

Esta fase permitió comprobar que el cambio a \textit{embeddings} era necesario desde el punto de vista metodológico, pero también que no resolvía por completo el problema de \textit{clustering}. La representación semántica reducía la dependencia de coincidencias literales entre palabras, aunque la calidad de los \textit{clusters} seguía condicionada por la métrica utilizada, el método de \textit{clustering}, la reducción dimensional aplicada y el propio vocabulario de partida. Precisamente, la revisión de estas primeras agrupaciones permitió detectar que algunos términos no estaban contribuyendo a describir afinidades científicas, sino que introducían información contextual que solo aportaba ruido a la división. Esta observación motivó la depuración posterior del vocabulario antes de repetir las pruebas principales.

\subsection{Depuración del vocabulario y repetición del análisis}

La revisión de las primeras agrupaciones obtenidas con \textit{embeddings} permitió detectar que el vocabulario de partida seguía influyendo de forma importante en los resultados. Aunque la representación semántica reducía la dependencia de coincidencias literales entre palabras clave, algunos términos no describían realmente ámbitos científicos, sino localizaciones geográficas u otros elementos contextuales asociados a determinadas revistas.

La presencia de este tipo de palabras podía afectar a la interpretación de los \textit{clusters}, ya que introducía relaciones entre investigadores que no estaban necesariamente vinculadas a una afinidad temática real. Dos perfiles podían aparecer más próximos por compartir términos geográficos, por ejemplo, aunque esos términos no aportasen información relevante sobre las líneas de investigación. Por este motivo, se decidió revisar el vocabulario utilizado en la representación semántica y eliminar aquellas palabras que podían desplazar la agrupación hacia coincidencias poco informativas.
...
Tras esta revisión manual, se generó una versión depurada del vocabulario y se repitieron las pruebas principales sobre la nueva base temática. No se repitieron todas las combinaciones exploradas en fases anteriores, sino aquellas que habían mostrado mayor interés metodológico o interpretativo. En particular, se volvieron a evaluar configuraciones basadas en \textit{embeddings}, distintas medidas de proximidad, \textit{clustering} jerárquico, métodos basados en densidad y reducciones de dimensionalidad como PCA y UMAP.
...
\hline
Coseno + DBSCAN & 2 \textit{clusters} y 35,7\% de ruido & La reducción mediante PCA mejora el ruido, pero la estructura sigue siendo poco estable \\
\hline
...
\hline
Coseno + DBSCAN & 2 \textit{clusters} y 35,7\% de ruido & No resultó adecuado como configuración final por la proporción de ruido \\
\hline
\end{tabular}
...
Los resultados muestran que las configuraciones basadas en reducción de dimensionalidad adquirieron mayor relevancia en la comparación final. En particular, la combinación de UMAP, distancia coseno y \textit{clustering} jerárquico obtuvo el valor de Silhouette más alto y ofreció una separación visual más clara entre grupos, convirtiéndose en la configuración más prometedora desde el punto de vista cuantitativo y visual.
...
En la configuración UMAP seleccionada, antes de aplicar la reducción no lineal se utilizó PCA para conservar el 90\% de la varianza, reduciendo previamente la dimensionalidad de los \textit{embeddings}. Posteriormente, se aplicó UMAP con distancia coseno y \textit{clustering} jerárquico con enlace \textit{average}.

La Figura~\ref{fig:umap_embeddings_depurado} muestra la configuración más destacada de la comparación final, basada en \textit{embeddings} depurados, reducción mediante UMAP, distancia coseno y \textit{clustering} jerárquico. Esta visualización permite observar la separación obtenida entre los grupos y complementa el valor medio de Silhouette mostrado en la Tabla~\ref{tab:comparacion_final_configuraciones}.
...
Esta revisión ayudó a matizar la interpretación de las agrupaciones obtenidas. Aunque los \textit{clusters} podían reflejar ciertas proximidades entre perfiles, la presencia de palabras tan generales indicaba que no debían entenderse como áreas científicas cerradas ni como una clasificación estable de los investigadores. Por ello, también se revisó la distribución de investigadores entre grupos, ya que una partición con \textit{clusters} muy descompensados o definidos por términos poco específicos podía resultar poco útil aunque alcanzara un buen valor numérico.

También se revisó el solapamiento entre particiones obtenidas con distintas configuraciones. Esta comparación permitía comprobar si modelos diferentes agrupaban a los mismos investigadores de forma similar o si las particiones cambiaban de manera importante al modificar la métrica, la reducción dimensional o el número de grupos. Para ello se compararon especialmente tres configuraciones: \textit{clustering} jerárquico con distancia de correlación, \textit{clustering} jerárquico con distancia coseno y \textit{clustering} jerárquico con distancia coseno tras reducción mediante UMAP.

La comparación entre las configuraciones basadas en correlación y coseno mostró cierta correspondencia parcial entre algunos grupos, lo que indicaba la existencia de núcleos temáticos relativamente estables. Sin embargo, esta correspondencia no se mantenía de forma completa para todos los \textit{clusters}, ya que varios grupos aparecían fragmentados o redistribuidos al cambiar la métrica de distancia.

La introducción de UMAP produjo una separación visual más clara, pero también modificó de forma notable la estructura de grupos. Al comparar las particiones obtenidas con y sin UMAP, varios grupos diferenciados en los modelos jerárquicos originales aparecían concentrados en uno o dos \textit{clusters} del modelo proyectado. Este comportamiento indicaba que la reducción no lineal influía de forma importante en la organización final de los grupos, por lo que sus resultados debían interpretarse junto con el análisis de solapamiento.
...
\hline
Correlación vs. Coseno & Correspondencia parcial entre algunos \textit{clusters}, pero sin alineación global completa \\
\hline
Correlación vs. Coseno + UMAP & Ausencia de correspondencia directa entre particiones y concentración de coincidencias en \textit{clusters} dominantes \\
\hline
...
La Figura~\ref{fig:solapamiento_umap_coseno} muestra el solapamiento entre la configuración jerárquica basada en distancia coseno y la misma configuración tras aplicar UMAP. Cada celda representa el número de investigadores compartidos entre \textit{clusters} de ambas particiones.

\begin{figure}[H]
\centering
\includegraphics[width=0.78\textwidth]{imgs/solapamiento_investigadores_jerCos_vs_jerCosUMAP.png}
\caption{Solapamiento entre \textit{clustering} jerárquico con distancia coseno y \textit{clustering} jerárquico tras reducción mediante UMAP.}
\label{fig:solapamiento_umap_coseno}
\end{figure}

La comparación muestra que UMAP modifica de forma importante la organización de los grupos. Por ejemplo, el primer \textit{cluster} del modelo sin UMAP se reparte entre varios \textit{clusters} tras la proyección, con 11 investigadores en común con el \textit{cluster} 1 de UMAP, 3 con el \textit{cluster} 2 y 8 con el \textit{cluster} 4. Al mismo tiempo, el \textit{cluster} 3 de UMAP concentra investigadores procedentes de varios \textit{clusters} del modelo original, incluyendo 4 del \textit{cluster} 2, 7 del \textit{cluster} 3, 2 del \textit{cluster} 4 y 1 del \textit{cluster} 5. Esto indica que la reducción mediante UMAP no solo cambia la visualización, sino también la estructura final de los grupos, por lo que sus resultados deben interpretarse con cautela.
...
Por tanto, la configuración basada en UMAP, distancia coseno y \textit{clustering} jerárquico fue la más destacada desde los puntos de vista cuantitativo y visual, aunque las comparaciones entre modelos mostraron que la estructura temática no era completamente estable frente a cambios de métrica o de reducción dimensional. Por este motivo, sus resultados no deben interpretarse como una clasificación inalterable de los investigadores, sino como una aproximación exploratoria a posibles afinidades temáticas.

Aun así, los resultados obtenidos siguen siendo útiles para el objetivo exploratorio del trabajo. El \textit{clustering} permite complementar la información relacional proporcionada por los grafos, ofreciendo una perspectiva adicional sobre posibles proximidades temáticas entre investigadores. Su valor principal no reside en definir una clasificación definitiva del IUMPA, sino en proporcionar una herramienta analítica que ayude a identificar grupos plausibles que puedan ser interpretados con apoyo del conocimiento experto.

\section{Valoración del análisis semántico}

El análisis semántico permitió ampliar la explotación de la base de datos más allá de las relaciones explícitas representadas en los grafos. Mientras que los grafos muestran conexiones derivadas de publicaciones, revistas o proyectos compartidos, el \textit{clustering} trató de explorar posibles afinidades temáticas entre investigadores a partir de las revistas en las que habían publicado y de las palabras clave asociadas a ellas. De este modo, esta parte del trabajo aportó una perspectiva complementaria a la visualización relacional desarrollada anteriormente.

El proceso seguido tuvo un carácter claramente experimental. Las primeras representaciones basadas en palabras clave explícitas resultaron útiles como punto de partida, pero mostraron las limitaciones de comparar perfiles únicamente mediante coincidencias literales. La ponderación del vocabulario permitió refinar esta representación, aunque no resolvió por completo el problema. El paso a \textit{embeddings} semánticos supuso una mejora metodológica, ya que permitió comparar perfiles considerando la proximidad conceptual entre términos, pero también mostró que la calidad de las agrupaciones seguía dependiendo de la métrica utilizada, de la reducción dimensional y del vocabulario de partida.

Uno de los aspectos más relevantes del análisis fue la necesidad de revisar e interpretar los resultados de forma crítica. La depuración de términos de localización permitió reducir una fuente de similitud poco relacionada con el contenido científico, pero no generó por sí sola una estructura temática completamente estable. Del mismo modo, aunque algunas configuraciones alcanzaron valores de Silhouette relativamente altos, las comparaciones entre particiones mostraron que los grupos podían cambiar de forma apreciable al modificar la métrica o aplicar UMAP. Por ello, los \textit{clusters} obtenidos deben entenderse como una aproximación exploratoria a posibles afinidades temáticas.
...
\begin{itemize}
   ...
   \item \textbf{Mejora de la aplicación interactiva.} La aplicación podría ampliarse con nuevas funcionalidades de búsqueda, comparación, exportación de resultados o consulta resumida de determinados subconjuntos de información. En particular, podrían incorporarse buscadores específicos de revistas o proyectos, así como la posibilidad de mostrar de forma explícita qué revista o proyecto concreto justifica una conexión entre dos investigadores en los grafos de colaboración. También podrían añadirse mejoras para navegar grafos densos o métricas descriptivas de red que ayuden a interpretar mejor las relaciones visualizadas, manteniendo siempre el carácter exploratorio de la herramienta.

    \item \textbf{Exploración de nuevas técnicas de análisis semántico.} Futuras versiones podrían probar otras formas de representación y \textit{clustering}, como mapas autoorganizados (\textit{Self-Organizing Maps}, SOM) o nuevos modelos de \textit{embeddings} más adaptados al dominio científico. También podrían incorporarse nuevas métricas de evaluación de agrupaciones, las cuales permitirían valorar si otros enfoques ofrecen representaciones temáticas más estables que las obtenidas en este trabajo. Además, podría estudiarse una representación temática más rica que tuviera en cuenta no solo si un investigador ha publicado en una revista, sino también la frecuencia con la que aparece asociado a ella, de forma que las revistas más recurrentes pudieran tener mayor influencia en la construcción del perfil temático. En esta misma línea, podrían evaluarse esquemas de ponderación como TF-IDF, con el fin de ajustar la importancia de las palabras clave según su capacidad para diferenciar perfiles investigadores.
...
Además, el análisis semántico de investigadores permitió aplicar conceptos propios de la recuperación de información (\textit{Information Retrieval}), el aprendizaje automático no supervisado y la representación vectorial de texto. Durante esta fase se construyeron perfiles temáticos y se compararon distintas formas de representar la información antes de evaluar varias estrategias de agrupación, lo que permitió comprobar que el resultado no dependía únicamente del algoritmo de \textit{clustering} aplicado. También era necesario valorar cómo se construían los perfiles, qué información contenía el vocabulario, cómo se medía la similitud entre investigadores y hasta qué punto los grupos obtenidos resultaban interpretables.
...
\newblock \textit{Science}, 149(3683), 510--515, 1965.

\bibitem{moed}
Moed, H. F.
\newblock \textit{Citation Analysis in Research Evaluation}.
\newblock Springer, 2005.

\bibitem{kessler}
Kessler, M. M.
\newblock Bibliographic coupling between scientific papers.
\newblock \textit{American Documentation}, 14(1), 10--25, 1963.

\bibitem{small}
Small, H.
\newblock Co-citation in the scientific literature: A new measure of the relationship between two documents.
\newblock \textit{Journal of the American Society for Information Science}, 24(4), 265--269, 1973.

\bibitem{zupic}
Zupic, I. y Cater, T.
\newblock Bibliometric methods in management and organization.
\newblock \textit{Organizational Research Methods}, 18(3), 429--472, 2015.

\bibitem{angles}
Angles, R. y Gutierrez, C.
\newblock Survey of graph database models.
\newblock \textit{ACM Computing Surveys}, 40(1), 1--39, 2008.

\bibitem{robinson}
Robinson, I., Webber, J. y Eifrem, E.
\newblock \textit{Graph Databases}.
\newblock O'Reilly Media, 2015.

\bibitem{eck}
Van Eck, N. J. y Waltman, L.
\newblock Software survey: VOSviewer, a computer program for bibliometric mapping.
\newblock \textit{Scientometrics}, 84(2), 523--538, 2010.

\bibitem{cobo}
Cobo, M. J., López-Herrera, A. G., Herrera-Viedma, E. y Herrera, F.
\newblock SciMAT: A new science mapping analysis software tool.
\newblock \textit{Journal of the American Society for Information Science and Technology}, 63(8), 1609--1630, 2012.

\bibitem{shneiderman}
Shneiderman, B.
\newblock The eyes have it: A task by data type taxonomy for information visualizations.
\newblock \textit{Proceedings 1996 IEEE Symposium on Visual Languages}, 336--343, 1996.
...
\newblock R package. Disponible en: \url{https://cran.r-project.org/package=shiny}
...
\midrule
\texttt{Tipo de empleado} & Variable descriptiva que diferencia entre investigadores, personal en formación y personal investigador en formación. \\
\midrule
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{imgs/Investigadores_internos.png}
