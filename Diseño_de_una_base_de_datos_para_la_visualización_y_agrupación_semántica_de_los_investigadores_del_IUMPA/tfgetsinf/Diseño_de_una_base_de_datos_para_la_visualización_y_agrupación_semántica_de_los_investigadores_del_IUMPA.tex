...
Quiero agradecer, en primer lugar, a mis tutor por su orientación durante el desarrollo de este Trabajo Fin de Grado, por sus revisiones y por la ayuda prestada a la hora de enfocar el proyecto y valorar los resultados obtenidos.

También quiero agradecer al IUMPA la posibilidad de trabajar sobre un caso real relacionado con su actividad investigadora. Este contexto ha permitido que el proyecto no se limitase a un ejercicio académico, sino que abordase un problema aplicado de recopilación, organización, visualización y análisis de información.

Por último, quiero dar las gracias a mi familia y a las personas que me han acompañado durante estos años, por su apoyo, paciencia y confianza a lo largo de la carrera y durante la realización de este trabajo.
...
% Esta aplicación interactiva queda disponible como prototipo asociado al proyecto a través del siguiente \url{enlace}. Su acceso y reutilización quedan condicionados por la disponibilidad de los ficheros de datos utilizados y por las consideraciones de protección de  datos descritas en esta memoria. La versión desplegada para consulta utiliza una versión limitada de los datos, excluyendo información de contacto, como los correos electrónicos, al no ser necesaria para la exploración visual. De este modo, se reduce la exposición de datos personales no imprescindibles y se mantiene el carácter exploratorio de la herramienta.
